...
namespace CardVault.Infrastructure.Notifications;
...
public sealed class NotificationDispatcher : INotificationDispatcher
{
    ...
    private async Task EmitDeadLetterEventAsync(CustomerNotificationDeliveryEntity delivery, CancellationToken ct)
    {
