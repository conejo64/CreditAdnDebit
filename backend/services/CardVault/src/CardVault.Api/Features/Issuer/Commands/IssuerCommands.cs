...
namespace CardVault.Api.Features.Issuer.Commands;
...
public record SetPinCommand(Guid CardId, CardVault.Api.Controllers.SetPinRequest Request) : IRequest<IResult>;
