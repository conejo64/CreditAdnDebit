# Open Banking Query Access Specification

## Purpose

Define how CardVault authenticates external Open Banking clients and exposes scoped balance and transaction query APIs.
